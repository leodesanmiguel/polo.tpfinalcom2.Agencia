...
<html lang="es">
    ...
    <body>
        ...
        <%
            ...
            int  dni = (int) request.getSession().getAttribute("dniPer");
            String dniPer = String.valueOf(dni);
            String nacionalPer = (String) request.getSession().getAttribute("nacionalPer");
            String celularPer = (String) request.getSession().getAttribute("celularPer");
            String emailPer = (String) request.getSession().getAttribute("emailPer");
                                ...
                                <div class="col-lg-6">
                                    <div class="card-body p-md-5 mx-md-4">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <h4 class="mt-1 mb-5 pb-1">ADMINISTRADOR</h4>
                                        </div>
                                        ...
                                        <div class="form-outline mb-4">
                                            <h6 class="mt-1 mb-4 pb-1"><%= nombrePer%></h4>
                                        </div>
                                        <div class="form-outline mb-4">
                                            <h6 class="mt-1 mb-4 pb-1"><%= apellidoPer%></h4>
                                        </div>
                                        <div class="form-outline mb-4">
                                            <h6 class="mt-1 mb-4 pb-1"><%= domicilioPer%></h4>

                                        </div>
                                        <div class="form-outline mb-4">
                                            <h6 class="mt-1 mb-4 pb-1"><%= dniPer%></h4>

                                        </div>
                                        <div class="form-outline mb-4">
                                            <h6 class="mt-1 mb-4 pb-1"><%= nacionalPer%></h4>

                                        </div>
                                        <div class="form-outline mb-4">
                                            <h6 class="mt-1 mb-4 pb-1"><%= celularPer%></h4>

                                        </div>  
                                        <div class="form-outline mb-4">
                                            <h6 class="mt-1 mb-4 pb-1"><%= emailPer%></h4>

                                        </div>  

                                        <div class="  text-center pt-1 mb-5 pb-1">
                                            <input class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" 
                                                   type="submit"  value="Modificar Admin"> 
                                            <input class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" 
                                                   type="submit"  value="Crear Jefe">
