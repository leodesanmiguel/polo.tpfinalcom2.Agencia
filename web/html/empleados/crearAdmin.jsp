                                ...
                                <div class="col-lg-6">
                                    <div class="card-body p-md-5 mx-md-4">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <h4 class="mt-1 mb-5 pb-1">C R E A R   U N   A D M I N I S T R A D O R</h4>
                                        </div>
...
<div class="form-outline mb-6">
    <input type="text" id="usuario" name="usuario" enabled="false"
           class="form-control" 
           value=" <% sesion.getAttribute("usuario"); %> " disabled/>
    <input type="text" id="password" name="password" 
           class="form-control" 
           value=" <% sesion.getAttribute("password"); %> " disabled />
    ...
    <!-- <a class="text-muted" href="#!">Recupera Contraseña</a> -->
                                ...
                                <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                    <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                        ...
                                        <p>Creación de la Sessión :<% sesion.getCreationTime(); %></p>
                                        <p>Creación de la Sessión :
                                            <% Date momento = new Date(sesion.getCreationTime());
                                               out.println("Creación: " + momento);%></p>
                                        <hr>
                                        <p>Usuario    :<% sesion.getAttribute("usuario"); %></p>
                                        <p>Contraseña :<% sesion.getAttribute("password"); %></p>
